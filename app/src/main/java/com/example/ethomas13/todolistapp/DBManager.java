...
public class DBManager extends SQLiteOpenHelper
{
    ...
    {
        String sql = "create table " + TABLE_NAME_LIST + " (" + C_LIST_ID + " int primary key, " + C_LIST_DESCRIPTION + " text" + ")";
        String sql2 = "create table" + TABLE_NAME_ITEM + " (" + C_ITEM_ID + " int primary key, " + C_ITEM_DESCRIPTION + " text, "
                + C_ITEM_DATE + " text, " + C_ITEM_COMPLETED + " integer, FOREIGN KEY(" + C_LIST_ID + ") REFERENCES" + TABLE_NAME_LIST + " (" + C_LIST_ID + "))";
        Log.d(TAG, sql);
